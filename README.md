...
|---------|:--:|------------|----------|------------------|-------------|
| 1. 김민수 암 진단 | 1 | 계약자 김민수님 계약 조회해줘 | 없음 | customer_contract_lookup(이름=김민수) | 계약상태·계약일·만료일·해지일·갱신일 보험 용어로 표기 |
| 1 | 2 | 갑상선암 진단받았는데, 가입한 암보험으로 보험금 청구할 수 있어? | 김민수 2건 유지(치아+암) | 직전 조회한 암보험 기준 → 청구 안내(가입 불가 아님) | 면책기간(90일) 확인 후 청구 가능 여부·절차 안내 |
| 1 | 3 | 청구하려면 어떤 서류가 필요해? | 직전에 청구 가능 안내함 | claim_guide | 암진단비 청구 서류·방법·처리기간, 직전 대화 맥락 유지 |
| 1 | 4 | 추가로 가입하면 좋을 만한 보장이 있어? | 김민수 보유(치아·암) | 중복 확인 후 추가 보장 추천 | 기가입 기반 중복 아닌 상품만 추천 |
| 2. 윤지은 추가 설계 | 1 | 계약자 윤지은님 계약 조회해줘 | 없음 | customer_contract_lookup(이름=윤지은) | 55세 여성, 3건 유지, 계약일·만료일·갱신일 |
| 2 | 2 | 치매 보장 추가하고 싶은데, 지금 가진 상품이랑 겹치지 않는 치매보험 있어? | 윤지은 3건(간편건강·치아·종신) | product_search(치매) + 중복 여부 판단 | 치매 상품 2종 등, 기가입과 겹치지 않는 것만 |
| 2 | 3 | 치매간병보험이랑 실속치매보험 차이 뭐야? 55세 여성 기준 보험료도 비교해줘 | 윤지은 55세 여성 | premium_compare, 보험료 비교 | 55세 여성 기준 비교, 직전 턴 나이·성별 재사용 |
| 2 | 4 | **지금 유지 중인 세 계약 합쳐서 월 보험료 얼마나 나와?** | 윤지은 55세 여성, 3건(간편건강·치아·종신) | **3건 상품에 대해 premium_estimate(55, F) 각각 호출 후 합산** | "조회할 수 없습니다" 금지. 3건 예상 보험료 합계 제시 |
| 3. 최수진 부활 | 1 | 계약자 최수진님 계약 현황 알려줘 | 없음 | customer_contract_lookup(이름=최수진) | 유지 1건(종신) + 해지 1건(암), 해지일 표기 |
| 3 | 2 | 해지한 암보험 부활할 수 있어? 조건이 뭐야? | 최수진 해지된 암보험 | underwriting_reinstatement_rule | 부활 요건(3년·연체보험료·면책 재적용 등) |
| 3 | 3 | 부활이 어렵다면 60세 여성이 가입할 수 있는 암보험 있어? | 최수진 60세 여성 | product_search(암) + 가입 조건 | 60세 여성 기준, 직전 맥락 나이·성별 사용 |
| 3 | 4 | 지금 유지 중인 종신보험 보장 내용 알려줘 | 최수진 유지 1건 종신 | coverage_summary(해당 종신) | 직전 조회한 '유지 중인 종신보험' 1건 기준 보장 요약 |
| 4. 택시기사+고혈압 | 1 | 48세 남성인데 택시기사야. 고혈압 약 복용 중이고 암보험 가입하고 싶대 | 없음 | 직업·유병력 파악 | 복합 질문 인식, 단계별 답변 가능 안내 |
| 4 | 2 | 택시기사면 직업 위험등급 때문에 가입 거절될 수도 있어? | 48세 남성, 택시기사 | underwriting_high_risk_job_check | 택시기사 할증/위험등급, 직전 직업·병력 맥락 유지 |
| 4 | 3 | 그러면 첫날부터암보험 가입 조건이랑 보장 내용 자세히 알려줘 | 직업 등급 + 고혈압 | coverage_detail, underwriting_precheck | 첫날부터암보험 보장 상세, 고혈압·할증 조건 반영 |
| 4 | 4 | 간편심사로 가입 가능한 건강보험도 있어? | 48세 남성, 고혈압, 택시기사 | product_search(간편심사 건강) | 간편심사 상품 1~2종, 직전 맥락(직업·병력) 유지 |
| 5. 시니어 종합 | 1 | 70세 아버지인데 사망보장이랑 치아보험 둘 다 알아보고 싶대 | 없음 | product_search(사망·치아) | 70세 가능 상품 추천, '아버지'=남성 맥락 |
| 5 | 2 | 건강해지는종신보험 보장 내용이랑 연금전환 조건 알려줘 | 70세, 직전 상품 맥락 | coverage_summary | 해당 상품 보장·연금전환만 |
| 5 | 3 | 든든한실버치아보험 70세에 가입 가능해? 보장 범위는? | 70세 | 가입 조건 + coverage | 70세 가입 가능 여부 + 보장 범위, 직전 나이 재사용 |
| 5 | 4 | **방금 말한 두 상품 다 가입하면 월 보험료 얼마쯤 나와?** | 70세 **남성**(아버지), 직전 두 상품(종신·실버치아) | premium_estimate(70, **M**) 2회 호출 후 합산 | '방금 말한 두 상품'=직전 맥락. 아버지→남성으로 산출. "성별 필요" 반복 금지 |
