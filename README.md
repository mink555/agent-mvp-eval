...
|---|---------|:--:|-----------------|------------|
| 1 | **기가입 계약자 암 진단 → 청구** | 4 | 계약 조회(2건 유지, 계약일·만료일·갱신일) → 직전 조회한 암보험 기준 청구 가능 여부(가입 불가 아님) → 청구 필요 서류 → 기가입 기반 추가 보장 추천 | customer_contract_lookup, claim_guide, product_search 등 |
...
| 4 | **고위험 직업 + 유병력 심사** | 4 | 택시기사 직업 위험등급 → 고혈압 인수심사·암보험 가입 조건 → 간편심사 건강보험 안내 | underwriting_high_risk_job_check, underwriting_precheck, product_search |
...
| 2. 윤지은 추가 설계 | 1 | 윤지은님 보유 계약 먼저 확인해줘 | 없음 | customer_contract_lookup(이름=윤지은) | 55세 여성, 3건 유지, 계약일·만료일·갱신일 |
...
| 4 | 2 | 직업 위험등급 먼저 확인해줘 | 48세 남성, 택시기사 | underwriting_high_risk_job_check | 택시기사 할증/위험등급 |
| 4 | 3 | 그러면 암보험 첫날부터 가입 가능한 조건이 뭐야? 고혈압이면 거절될 수 있어? | 직업 등급 + 고혈압 | underwriting_precheck 등 | 고혈압 인수심사·거절 가능성, 직전 직업 정보 유지 |
| 4 | 4 | 간편심사로 가입 가능한 건강보험 있어? | 48세 남성, 일반심사 부담 | product_search(간편심사 건강) | 간편심사 상품 1~2종, 맥락 유지 |
